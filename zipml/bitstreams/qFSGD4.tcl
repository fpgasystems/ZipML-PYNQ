...
CONFIG.NUM_MI {2} \
  ...
  # Create instance: qFSGD_0, and set properties
...
CONFIG.CONST_WIDTH {31} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins qFSGD_0/s_axis]
